...
# Queue SQS
aws --endpoint-url=http://localhost:4566 sqs send-message --queue-url http://localhost:4566/000000000000/chronicle-jobs.fifo --message-body '{"jobId":"123","url":"https://www.youtube.com/watch?v=HEgrMoaWDIM","filename":"abc123.mkv","s3Key":"recordings/2025/04/30/abc123.mkv"}' --message-group-id default
